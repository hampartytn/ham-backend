...
export const PAYMENT_PURPOSE_EMPLOYER_MEMBERSHIP = 'EMPLOYER_MEMBERSHIP';
export const PAYMENT_PURPOSE_MEMBERSHIP = 'MEMBERSHIP';
export const PAYMENT_CURRENCY_INR = 'INR';
export const EMPLOYEE_MEMBERSHIP_PLAN_CODE = 'employee-ham-membership';
export const EMPLOYER_MEMBERSHIP_PLAN_CODE = 'employer-ham-membership';
